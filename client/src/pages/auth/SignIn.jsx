      ...
      <section className="w-full md:w-1/2 lg:w-7/12 flex-1 flex items-center justify-center p-4 sm:p-6 md:p-12 my-auto">
        <div className="w-full max-w-md">
          ...
          <div className="mb-4 sm:mb-6 text-center sm:text-left">
            <h2 className="text-xl sm:text-2xl md:text-[28px] font-bold text-[#03224d]">Welcome Back</h2>
            <p className="text-xs sm:text-sm text-[#44474f] mt-1">Please enter your academic credentials to sign in.</p>
          </div>
