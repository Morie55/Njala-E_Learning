  ...
  return (
    <AppLayout role="admin">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
        <div>
          <h2 className="text-2xl sm:text-[32px] font-semibold text-[#03224d]">Departments</h2>
          <p className="text-[13px] sm:text-[14px] text-[#44474f]">Manage academic sub-departments within Njala Schools.</p>
        </div>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
          <select
            value={selectedSchool}
            onChange={(e) => handleFilterChange(e.target.value)}
            className="w-full sm:w-auto border border-[#c4c6d0] rounded-md px-3 py-2 text-[13px] font-semibold text-[#03224d] bg-white focus:outline-none focus:ring-2 focus:ring-[#03224d]"
          >
          ...
          <button
            onClick={openCreate}
            className="w-full sm:w-auto justify-center bg-[#03224d] text-white px-4 py-2 rounded text-[12px] font-bold hover:opacity-90 flex items-center gap-2 cursor-pointer shrink-0"
          >
      ...
      <div className="bg-white border border-[#c4c6d0] rounded-lg overflow-x-auto">
        {deleteError && (
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-3 sm:justify-end pt-2">
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 border border-[#c4c6d0] text-[#44474f] rounded text-[14px] font-bold hover:bg-[#f0eded] cursor-pointer text-center"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={saving}
                className="w-full sm:w-auto bg-[#03224d] text-white px-5 py-2.5 rounded text-[14px] font-bold hover:opacity-90 disabled:opacity-50 cursor-pointer text-center"
              >
